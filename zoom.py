...
# Variables to track previous distance for zooming
        ...
        for hand in hands:
            ...
            for id, landmark in enumerate(landmarks):
                ...
                if id == 4:  # Thumb tip
                    ...
                    # Zoom in or out based on the distance between index finger and thumb
                    if previous_distance is not None:
                        if distance < previous_distance - 20:  # Adjust this threshold for zooming in
                            if not zooming:
                                pyautogui.hotkey('ctrl', '+')  # Zoom in
                                zooming = True
                        elif distance > previous_distance + 20:  # Adjust this threshold for zooming out
                            if not zooming:
